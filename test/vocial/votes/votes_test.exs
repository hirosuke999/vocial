defmodule Vocial.VotesTest do
  ...
  describe "polls" do
    ...
    test "list_poll/0 returns all polls", %{user: user} do
    ...
    test "create_poll_with_options/2 does not create a poll with bad data", %{user: user} do
      title = "Bad Poll"
      options = ["Choice 1", nil, "Choice 2"]
